...
import softexpert.task.com.Data.data.DataResponse;
...
public class MainInteractorImpl implements MainInteractor {
    ...
    public void provideData(Context context, boolean isRestoring) {
        ...
        if (isRestoring) {
            ...
            List<Data> existingData = EarthquakeDataManager.getInstance().getLatestData();
    ...
    private final Response.Listener<String> onEQLoaded = new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            ...
            try {
                DataResponse eqResponse = gson.fromJson(response, DataResponse.class);
                mGetDatalistener.onSuccess("data success", eqResponse.getData()
                );
